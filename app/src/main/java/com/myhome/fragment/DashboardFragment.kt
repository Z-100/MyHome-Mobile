    ...
    private fun generateBindings() {
        binding.navigationBar.setOnItemSelectedListener {
                item -> when (item.itemId) {
                    R.id.footer_home_btn -> findNavController().navigate(DashboardFragmentDirections.dashboardToDashboard().setBackButton(R.id.dashboard_to_dashboard))
                    R.id.footer_kitchen_btn -> findNavController().navigate(DashboardFragmentDirections.dashboardToKitchen().setBackButton(R.id.kitchen_to_dashboard))
                    R.id.footer_rooms_btn -> findNavController().navigate(DashboardFragmentDirections.dashboardToRooms().setBackButton(R.id.rooms_to_dashboard))
                }
            true
        }
